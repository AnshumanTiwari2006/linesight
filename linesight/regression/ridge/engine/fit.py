...
from linesight.regression.ridge.engine.gradient_step import _gradient_step
from linesight.regression.ridge.engine.compute_loss import _compute_loss


def _fit(self, X, y):
    """
    Train Ridge regression: y_pred = dot(X, weights) + bias, with L2 regularization penalty.
