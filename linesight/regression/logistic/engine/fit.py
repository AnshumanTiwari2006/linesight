import numpy as np
import warnings
from linesight.utils.validators import _validate_Xy, _validate_binary_y
...
from linesight.regression.logistic.engine.gradient_step import _gradient_step
from linesight.regression.logistic.engine.compute_loss import _compute_loss


def _fit(self, X, y):
    """
    Train logistic regression (binary classification) using cross-entropy loss.
